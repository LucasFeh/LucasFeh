...
Atuo com automação de processos internos, aplicações corporativas e soluções para demandas operacionais, além de arquitetura de automação industrial, análise de processos e consultoria interna para identificação de oportunidades de digitalização.

Uso **Inteligência Artificial como acelerador** do ciclo de desenvolvimento — pesquisa técnica, prototipação, implementação e análise de alternativas arquiteturais — mantendo o foco em arquitetura, integração, segurança, confiabilidade e manutenibilidade.

> Abordagem **technology-agnostic**: a tecnologia é escolhida pelo requisito do problema, não o problema limitado a um framework.
...
- Arquitetura e desenvolvimento de soluções internas
- Automação de processos corporativos
- Aplicações para necessidades operacionais
- Levantamento e análise de requisitos
- Integração entre sistemas e serviços
- Prototipação rápida e validação de soluções
...
- Hospedagem e operação em infraestrutura interna
- Planejamento de escalabilidade vertical e horizontal
- Pesquisa e aplicação de cibersegurança
- Análise técnica e resolução de problemas multidisciplinares
...
<p>
  ...
  <img src="https://img.shields.io/badge/API_REST-005571?style=for-the-badge&logo=fastapi&logoColor=white">
</p>
...
<p>
  ...
  <img src="https://img.shields.io/badge/Modelagem_de_Dados-336791?style=for-the-badge&logo=postgresql&logoColor=white">
</p>
...
<p>
  ...
  <img src="https://img.shields.io/badge/Redes_e_Seguran%C3%A7a-0F172A?style=for-the-badge&logo=cloudflare&logoColor=white">
  <img src="https://img.shields.io/badge/IA_Generativa-412991?style=for-the-badge&logo=openai&logoColor=white">
</p>

<details>
<summary><b>Palavras-chave</b></summary>
<br>

Arquitetura de Software, Arquitetura de Soluções, Automação de Processos, RPA, Automação Industrial, Levantamento de Requisitos, Análise de Requisitos, Integração de Sistemas, API REST, Webhooks, Microsserviços, Docker, Containerização, Linux, Infraestrutura On-Premise, Escalabilidade Horizontal e Vertical, DevOps, CI/CD, Git, GitLab, GitHub, Cibersegurança, Segurança da Informação, Redes, Banco de Dados Relacional, Banco de Dados NoSQL, SQL, Modelagem de Dados, Python, JavaScript, TypeScript, C#, C++, C, C++ Embarcado, Sistemas Embarcados, HTML, CSS, VBA, Pascal, React, React Native, Angular, Node.js, Desenvolvimento Full Stack, Desenvolvimento Mobile, Inteligência Artificial, IA Generativa, LLM, Desenvolvimento Assistido por IA, Prototipação, Metodologias Ágeis, Scrum, Kanban, Scrum Master, Consultoria Técnica, Transformação Digital.
