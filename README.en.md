...
<p align="center">
  <b>Solutions & Automation Developer</b> &nbsp;•&nbsp; Systems Architecture &nbsp;•&nbsp; AI-Assisted Development
</p>

<p align="center">
  <a href="https://github.com/LucasFeh/LucasFeh/blob/main/README.md"><img src="https://img.shields.io/badge/PT--BR-ler_em_portugu%C3%AAs-30363D?style=for-the-badge" alt="Português"></a>
  <a href="https://github.com/LucasFeh/LucasFeh/blob/main/README.en.md"><img src="https://img.shields.io/badge/EN-active-2EA043?style=for-the-badge" alt="English"></a>
</p>
...
I turn business problems into technology solutions — from requirements gathering and architecture design through development, deployment and long-term evolution.

I work on internal process automation, corporate applications and solutions for operational demands, as well as industrial automation architecture, process analysis and internal consulting to identify digitalization opportunities.

I use **AI as an accelerator** across the development cycle — technical research, prototyping, implementation and evaluation of architectural alternatives — while keeping the focus on architecture, integration, security, reliability and maintainability.

> **Technology-agnostic** approach: the stack is chosen to fit the problem's requirements, instead of forcing the problem into a single language or framework.
...
- Architecture and development of internal solutions
- Corporate process automation
- Applications for operational needs
...
- Hosting and operating apps on internal infrastructure
- Vertical and horizontal scalability planning
- Cybersecurity research and application
- Technical analysis and multidisciplinary problem solving
...
<p>
  ...
  <img src="https://img.shields.io/badge/Networking_%26_Security-0F172A?style=for-the-badge&logo=cloudflare&logoColor=white">
...
Software Architecture, Solutions Architecture, Process Automation, RPA, Industrial Automation, Requirements Gathering, Requirements Analysis, Systems Integration, REST API, Webhooks, Microservices, Docker, Containerization, Linux, On-Premise Infrastructure, Horizontal and Vertical Scalability, DevOps, CI/CD, Git, GitLab, GitHub, Cybersecurity, Information Security, Networking, Relational Databases, NoSQL Databases, SQL, Data Modeling, Python, JavaScript, TypeScript, C#, C++, C, Embedded C++, Embedded Systems, HTML, CSS, VBA, Pascal, React, React Native, Angular, Node.js, Full Stack Development, Mobile Development, Artificial Intelligence, Generative AI, LLM, AI-Assisted Development, Prototyping, Agile Methodologies, Scrum, Kanban, Scrum Master, Technical Consulting, Digital Transformation.
...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=LucasFeh&label=Profile+views&color=58A6FF&style=for-the-badge" alt="views">
</p>
